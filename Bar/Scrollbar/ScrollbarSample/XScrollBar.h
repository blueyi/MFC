...
public:
	...
	BOOL CreateFromWindow(DWORD dwStyle,
						  CWnd* pParentWnd,
						  HWND hStatic,
						  HWND hStaticLeftArrow2,
						  HWND hStaticRightArrow2,
						  UINT nId);
...
protected:
	...
	CBitmap		m_bmpUpLeftArrow2;		// bitmap for up/left arrow
	CBitmap		m_bmpDownRightArrow;	// bitmap for down/right arrow
	CBitmap		m_bmpDownRightArrow2;	// bitmap for down/right arrow
...
protected:
	...
	DECLARE_MESSAGE_MAP()
private:
	CRect m_rectRightArrow2;
	CRect m_rectLeftArrow2;
};
