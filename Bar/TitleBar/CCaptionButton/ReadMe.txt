========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : TitleBarButton
========================================================================


Diese TitleBarButton-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre TitleBarButton-Anwendung bilden.
...
TitleBarButton.h
	...
	Anwendungsklasse CTitleBarButtonApp.
...
res\TitleBarButton.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei TitleBarButton.rc eingebunden.

res\TitleBarButton.rc2
...
TitleBarButtonDlg.h, TitleBarButtonDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CTitleBarButtonDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in TitleBarButton.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	TitleBarButton.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
