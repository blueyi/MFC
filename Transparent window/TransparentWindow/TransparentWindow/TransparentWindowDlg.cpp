...
CTransparentWindowDlg::CTransparentWindowDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CTransparentWindowDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CTransparentWindowDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CTransparentWindowDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CTransparentWindowDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CTransparentWindowDlg::OnBnClickedOk()
{
