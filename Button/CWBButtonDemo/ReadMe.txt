========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : CWBButtonDemo
========================================================================


AppWizard が生成した CWBButtonDemo には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには CWBButtonDemo を構成している各ファイルの概要説明が含まれています。
...
CWBButtonDemo.h
    ...
    みます） をインクルードし、また CCWBButtonDemoApp アプリケーションクラスを宣
    言します。

CWBButtonDemo.cpp
    このファイルは CCWBButtonDemoApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\CWBButtonDemo.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル CWBButtonDemo.rc によってインクルード
    されます。

res\CWBButtonDemo.rc2
...
CWBButtonDemoDlg.h, CWBButtonDemoDlg.cpp - ダイアログ
    これらのファイルは CCWBButtonDemoDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な CWBButtonDemo.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) CWBButtonDemo.pch 
