...
BOOL CTestDialogDlg::OnInitDialog()
{
	...
	sheet.Attach(this);
	d1.Create(IDD_DIALOG1, this); d1.SetWindowText(_T("First"));
	d2.Create(IDD_DIALOG2, this); d2.SetWindowText(_T("Second"));
	d3.Create(IDD_DIALOG3, this); d3.SetWindowText(_T("Third"));
