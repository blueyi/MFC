========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Example
========================================================================


Diese Example-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Example.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Example.rc eingebunden.
...
ExampleDlg.h, ExampleDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CExampleDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Example.rc, die mit Microsoft Developer Studio
...
StdAfx.h, StdAfx.cpp
	...
	Example.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
