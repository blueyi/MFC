...
$$Root$$.h
    ...
    C$$Safe_root$$App application class.
...
AppWizard creates $$NUM_PAGES$$ page classes:

$$BEGINLOOP(NUM_PAGES)
$$PAGE_FILE$$.h, $$PAGE_FILE$$.cpp - contain your $$PAGE_CLASS$$ class. 
	This class defines the behavior of one of your application's pages.
	The dialog's template is in $$Root$$.rc, which can be edited in
