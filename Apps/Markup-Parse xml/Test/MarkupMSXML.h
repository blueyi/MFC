...
// MARKUP_MSXML3 default, compile for MSXML 3.0 interface, works with MSXML 3.0+
// MARKUP_MSXML4 compile for MSXML 4.0 interface, works with MSXML 3.0+
// MARKUP_MSXML6 compile for MSXML 6.0 interface, works with MSXML 3.0+
//
...
public:
	...
	// MSXML only
#if ! defined(MARKUP_MSXML1)
	CString Transform( CMarkupMSXML& xsl );
#endif
...
protected:
	...
	bool x_GetReason();
	bool x_AddResult( CString strID );
