...
const int cnstLSDI1B		= 21;
const int cnstEPDWI1B		= 22;
/**[xd 2008.03.10]增加SSFP Begin**/
const int cnstSSFP3D	    = 23;
/**[xd 2008.03.10]增加SSFP End**/
//Added by Tom, --2008.07.10
/**[xd 2008.12.06]增加spgr预饱和 Begin**/
const int cnstSPGR2DSAT		= 116;
...
const int cnstOverSampling				= 0x800;
//@}
...
enum ECoilType
{
	...
	//Added by Tom, --2008.07.10
	ctSoftHeadCoilS		= 161,	//Soft head coil for intervention
    ctSoftBodyCoilS     = 162,  //Soft body coil for intervention
};
