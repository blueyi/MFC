...
CSplitterDlg::CSplitterDlg(CWnd* pParent /*=NULL*/):ZSplitterDlgImpl<CDialog>(CSplitterDlg::IDD)
{
...
BEGIN_MESSAGE_MAP(CSplitterDlg, ZSplitterDlgImpl<CDialog>)
