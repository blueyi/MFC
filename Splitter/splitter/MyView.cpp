...
CMyView1::CMyView1()   
//	: ZSplitterDlgImpl<CFormView>(CMyView1::IDD)
	  : ZSplitterDlgImpl<CView>()
...
//	CFormView::OnInitialUpdate();
  ...
  wnd1.Create("QQQ1",WS_CHILD|WS_VISIBLE,rect1, this, ID_MY_WND1);
  wnd2.Create("QQQ2",WS_CHILD|WS_VISIBLE,rect2, this, ID_MY_WND2);
