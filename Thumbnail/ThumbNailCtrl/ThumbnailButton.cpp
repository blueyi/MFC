...
#define RGBTHUMBBKGD RGB( 101, 73, 92 )
...
BOOL CThumbnailButton::OnEraseBkgnd(CDC* pDC) 
  ...
  if( !m_bTracking )
    ...
    pDC->FillSolidRect( 1, 1, rWnd.Width()-1, rWnd.Height()-1, RGB(224,224,224) );

  if( m_bClickSelected )
      pDC->FillSolidRect( 1, 1, rWnd.Width()-1, rWnd.Height()-1, RGB(17,31,157) );
