...
#define RGBTHUMBCTRLBKGD RGB( 155, 185, 211 )
...
void CThumbNailControl::Add( const CString& sPath )
  ...
  long nThumbImgWidth  = (int)(0.85f*m_nThumbWidth);
  long nThumbImgHeight = (int)(0.85f*m_nThumbHeight);
...
void CThumbNailControl::RecalScrollBars()
  ...
  long nTotalHeight = m_nThumbHeight * m_nRow + DEFAULT_SEPERATOR * ( 1 + m_nRow );
