// Excel Demo.cpp : Defines the class behaviors for the application.
//
...
BOOL CExcelDemoApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_EXCELDTYPE,
		RUNTIME_CLASS(CExcelDemoDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CExcelDemoView));
...
/////////////////////////////////////////////////////////////////////////////
// CExcelDemoApp message handlers
