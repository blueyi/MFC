...
#define ID_DISABLE 1001
#define ID_ENABLE 1002


BEGIN_MESSAGE_MAP(CCellTypeDemoGrid,CUGCtrl)
	//{{AFX_MSG_MAP(CCellTypeDemoGrid)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/***************************************************
****************************************************/
CCellTypeDemoGrid::CCellTypeDemoGrid()
{
}
/***************************************************
****************************************************/
...
****************************************************/
void CCellTypeDemoGrid::OnSetup()
{
	//setup the fonts
...
void CCellTypeDemoGrid::OnReset()
{
	CUGCell cell;
	int rows,cols;
	int row;
...
/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnDrawFocusRect(CDC *dc,RECT *rect){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnCellTypeNotify(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnDropList(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnCheckbox(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnDateTime(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnPushButton(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnEllipsisButton(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnSpinButton(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnSlider(long ID,int col,long row,long msg,long param){
...
/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow){
	return FALSE;
}

/***************************************************
****************************************************/
int CCellTypeDemoGrid::OnEditFinish(int col, long row,CWnd* edit,LPCTSTR string,BOOL cancelFlag){
...
/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnCharDown(UINT *vcKey,BOOL processed){
...
/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnGetCell(int col,long row,CUGCell *cell){

}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){
...
/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){
	...
	if (nCellTypeIndex == 2)
	{
		...
		EmptyMenu();
		if (isDisabled) AddMenuItem(ID_ENABLE, "Enable checkbox");
		else AddMenuItem(ID_DISABLE, "Disable checkbox");
	}
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed){
...
/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){
	
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){

}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed){
}

/***************************************************
****************************************************/
void CCellTypeDemoGrid::SetupSection(long row, LPCSTR title){
...
void CCellTypeDemoGrid::OnMenuCommand(int col,long row,int section,int item)
{
	CUGCell cell;
	GetCell(col, row, &cell);
