// Ex13.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx13App, CWinApp)
	//{{AFX_MSG_MAP(CEx13App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx13App object

CEx13App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx13App initialization

BOOL CEx13App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx13Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx13View));
