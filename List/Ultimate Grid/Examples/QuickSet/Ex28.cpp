// Ex28.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx28App, CWinApp)
	//{{AFX_MSG_MAP(CEx28App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx28App object

CEx28App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx28App initialization

BOOL CEx28App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx28Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx28View));
