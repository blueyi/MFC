// Ex7.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx7App, CWinApp)
	//{{AFX_MSG_MAP(CEx7App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx7App object

CEx7App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx7App initialization

BOOL CEx7App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx7Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx7View));
