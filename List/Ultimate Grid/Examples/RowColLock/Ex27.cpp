// Ex27.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx27App, CWinApp)
	//{{AFX_MSG_MAP(CEx27App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx27App object

CEx27App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx27App initialization

BOOL CEx27App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx27Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx27View));
