// Ex6.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx6App, CWinApp)
	//{{AFX_MSG_MAP(CEx6App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx6App object

CEx6App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx6App initialization

BOOL CEx6App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx6Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx6View));
