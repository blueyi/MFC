// EX18.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEX18App, CWinApp)
	//{{AFX_MSG_MAP(CEX18App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEX18App object

CEX18App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEX18App initialization

BOOL CEX18App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEX18Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEX18View));
