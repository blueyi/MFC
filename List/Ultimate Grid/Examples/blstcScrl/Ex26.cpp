// Ex26.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CEx26App, CWinApp)
	//{{AFX_MSG_MAP(CEx26App)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx26App object

CEx26App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx26App initialization

BOOL CEx26App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx26Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx26View));
	...
	Sleep(2000);	// Delay two seconds for splash
