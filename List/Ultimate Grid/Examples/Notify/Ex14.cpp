// Ex14.cpp : Defines the class behaviors for the application.
//
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEx14App object

CEx14App theApp;

/////////////////////////////////////////////////////////////////////////////
// CEx14App initialization

BOOL CEx14App::InitInstance()
{
...
//	Enable3dControlsStatic();	// Call this when linking to MFC statically
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEx14Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEx14View));
