...
#include "CellCtrls\CellPushButton.h"
...
#define CTRLTYPE_TIMECTRL		_T("Time Ctrl")
#define CTRLTYPE_PUSHBUTTON		_T("Push Button")
...
BOOL CConfigurableCtrlDlg::OnInitDialog()
{
	...
	m_Ctrl_Type.AddString(CTRLTYPE_TIMECTRL);
	m_Ctrl_Type.AddString(CTRLTYPE_PUSHBUTTON);
...
// A few lines:
	...
	m_ListCtrl.InsertItem(10, _T("A push button"));
...
//	pDtCrtl->SetYMD(1776, 7, 4);
	...
	m_ListCtrl.SetItem(10, 1, new CCellPushButton, _T("Please push."));
...
void CConfigurableCtrlDlg::OnBnClickedCtrlAdd()
{
	...
	else if (!str.Compare( CTRLTYPE_TIMECTRL))
		pCtrl = new CCellTimeCtrl;
	else if (!str.Compare( CTRLTYPE_PUSHBUTTON))
		pCtrl = new CCellPushButton;
